...
class Threedmodel(models.Model):
    ...
    finds = models.ForeignKey(Finds, blank=True, null=True, on_delete=models.CASCADE)
    ...
    resource_metadata = models.ForeignKey(Project, blank=True, null=True, on_delete=models.CASCADE)
