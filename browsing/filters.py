...
class MapListFilter(django_filters.FilterSet):
    name = django_filters.CharFilter(
        lookup_expr='icontains', label='Site name',
        help_text=False
        )
...
#settlement fields
    ...
    area__settlement_structure = django_filters.ModelMultipleChoiceFilter(
        ...
        help_text=False, label="Settlement structure"
        )
    ...
    area__settlement_human_remains = django_filters.ChoiceFilter(
        choices=YESNO_CHOICES, help_text=False,
        label="Settlement human remains"
        )
...
#cave/rockshelters fields
    ...
    area__cave_rockshelters_human_remains = django_filters.ChoiceFilter(
        choices=YESNO_CHOICES, help_text=False,
        label="Cave rockshelters human remains"
        )

    area__cave_rockshelters_evidence_of_occupation = django_filters.ModelMultipleChoiceFilter(
...
#cemetery/graves fields
    ...
    area__cemetery_or_graves_mortuary_features = django_filters.ModelMultipleChoiceFilter(
...
# Pottery fields
    ...
    area__finds__pottery_type = django_filters.CharFilter(
        lookup_expr='icontains',
        help_text=False, label="Pottery type"
    )
...
#cave/rockshelters fields
    ...
    cave_rockshelters_human_remains = django_filters.ChoiceFilter(choices=YESNO_CHOICES,
        help_text=False)
