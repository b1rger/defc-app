...
class DC_region(GenericMethods):
    ...
    authorityfile_id = models.CharField(
        max_length=100, blank=True, null=True, help_text="Identifier provided by www.GeoNames.org")
    lat = models.FloatField(blank=True, null=True)
    lng = models.FloatField(blank=True, null=True)
...
class DC_area_agegroups(GenericMethods):
    name = models.CharField(
        max_length=100, blank=True, null=True, help_text="Age.")


class DC_area_sexes(GenericMethods):
    name = models.CharField(
        max_length=100, blank=True, null=True, help_text="Sex.")
...
class Site(TrackChanges):
    ...
    exact_location = models.CharField(
        max_length=50, choices=EXACT_LOCATION_CHOICES, default="no",
    ...
    number_of_activity_periods = models.IntegerField(
        blank=True, null=True, help_text="How many past activities have been recorded on the site?")
    reference = models.ManyToManyField(Book, blank=True,
